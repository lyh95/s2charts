        ...
        getDataFromData:function(data,callback){
        	if(data && data != null && data[0]){
                ...
                if(heads.length > 1){
                    ...
                    //1.取单位
                    //for(var m = 1; m < heads.length; m++){
                    //    unit[m-1] = heads[m];
                    //    var v = regex.exec(unit[m-1]);
                    //    if(v && v[0]){
                    //        unit[m-1] = v[0];
                    //    }
                    //}
                    ...
                    for(var k=1;k<heads.length;k++){
                        ...
                        for(var n = 0; n<bodys[k].length; n++){
                            sum += bodys[k][n];
                        }
                        pieData.push({
                            name: heads[k],
