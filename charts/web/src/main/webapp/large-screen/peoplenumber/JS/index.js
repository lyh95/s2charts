...
=======
           var dateList = this.getSourceData()
>>>>>>> 72ada5a4abc8a693cf016a618fd9758f7d5179ce
...
=======
    $("#screen-edit").click(function () {
        ...
        $("#screen-effect1").mouseenter(function () {
            //判断编辑框在不在，不在加id
         if ($('#control-panel').css("display") == 'none') {
             $('#screen-edit1').append(" <button type='button' id='edit-button' value='编辑'>编辑</button>")
             //点编辑时，出现编辑框
             $("#screen-edit1 button").click(function () {
                 $("#control-panel").fadeIn()
                 //加载数据
        ...
        $("#screen-effect2").mouseenter(function () {
            {
                ...
                if ($('#control-panel').css("display") == 'none') {
                    ...
                    $('#screen-edit2').append(" <button type='button' id='edit-button' value='编辑'>编辑</button>")
                    //点编辑时，出现编辑框
        ...
        $("#screen-effect3").mouseenter(function ()
            {
                if ($('#control-panel').css("display") == 'none') {
                    $('#screen-edit3 ').append(" <button type='button' id='edit-button' value='编辑'>编辑</button>")
                    //点编辑时，出现编辑框
...
<<<<<<< HEAD
                ...
                $("#screen-edit2 button").click(function () {
                    ...
                    $.getJSON("./json/2.json", function (data){
=======
                $('#screen-edit4').append(" <button type='button' id='edit-button' value='编辑' >编辑</button>")
                  //点编辑时，出现编辑框
...
=======
                $('#screen-edit5 ').append(" <button type='button' id='edit-button' value='编辑'>编辑</button>")
                //点编辑时，出现编辑框
                $("#screen-edit5 button").click(function () {
                    $("#control-panel").fadeIn();
                    $.getJSON("./json/5.json", function (data){
...
var dv = document.getElementById("control-panel"); //获取元素
var x = 0;
var y = 0;
var l = 0;
var t = 0;
