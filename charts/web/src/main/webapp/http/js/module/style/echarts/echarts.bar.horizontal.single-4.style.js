...
define(function(require, exports, module) {
	...
	var templateHtml = require("/http/js/module/style/echarts/echarts.bar.horizontal.single-4.html.tpl");
    ...
    var EChartBarVerticalSingleStyle = (function(){
		...
		var initControlStyle = function(){
            ...
            var xAxisStyleMin = xAxisStyle.xAxis[0].min;
            if(xAxisStyleMin != 0){
                $("#chart-xAxis-change").attr("value",xAxisStyleMin).val(xAxisStyleMin);
