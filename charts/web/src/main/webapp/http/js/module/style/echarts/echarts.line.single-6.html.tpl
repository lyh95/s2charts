...
<div class="tab-content bs-docs-sidenav-content pull-left" style="height: 500px;width: 300px;overflow: scroll">
    	...
    	<div class="panel-body">
		    ...
		    <div class="input-group pull-left" style="margin-left:10px;">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<input id="chart-legend-color-select" type="color" class="form-control" style="width:45px;" value="#f17a52" />
		    </div><!-- /input-group -->
		    <div class="clearfix"></div>
    	</div>
    </div>
    	...
    	<div class="panel-body">
	    	...
	    	<div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<input id="chart-font-color-select" disabled="disabled" type="color" class="form-control" style="width:45px;" value="#f17a52" />
		    </div><!-- /input-group -->
		    <br/>
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<span class="input-group-addon" style="width:auto;">
		       		<input id="chart-font-size-range" disabled="disabled" type="range" value="12"  max="40" min="9">
		       	</span>
		    ...
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<span class="input-group-addon" style="width:auto;">
		        	<input id="chart-font-position-radio-1" name="chart-font-position-radio" type="radio"  checked="checked" value="top"  />
