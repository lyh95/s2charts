    ...
    <div class="panel panel-default">
    	...
    	<div class="panel-body">
            <div class="input-group">
                ...
                <span class="input-group-addon" style="width:auto;">
                    <input id="chart-inner-size-range" type="range" value="100"  max="240" min="0">
                </span>
                <input id="chart-inner-size-text" type="text" class="form-control" disabled="disabled" style="width:50px;" value="100" />
                <span class="input-group-addon" style="width:auto;">
                    px
                </span>
            </div><!-- /input-group -->
