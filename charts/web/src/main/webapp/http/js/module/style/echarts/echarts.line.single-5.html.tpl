  ...
  <div class="tab-pane active" id="panel-common">
    ...
    <div class="panel panel-default">
    	<div class="panel-body">
    		<div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		        	<input id="chart-show-smooth-check" checked="checked" type="checkbox">
		        	折线为平滑曲线
		      	</span>
		    </div><!-- /input-group -->
    	</div>
    	...
    	<div class="panel-body">
    		<div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<input id="chart-line-color-select" type="color" class="form-control" style="width:45px;" value="#2e8b57" />
		    </div><!-- /input-group -->
		    <br/>
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
    	...
    	<div class="panel-body">
		    ...
		    <div class="input-group pull-left" style="margin-left:10px;">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<input id="chart-legend-color-select" type="color" class="form-control" style="width:45px;" value="#2e8b57" />
		    </div><!-- /input-group -->
		    <div class="clearfix"></div>
    	</div>
    </div>
    	...
    	<div class="panel-body">
	    	...
	    	<div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<input id="chart-font-color-select" type="color" class="form-control" style="width:45px;" value="#2e8b57" />
		    </div><!-- /input-group -->
		    <br/>
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
