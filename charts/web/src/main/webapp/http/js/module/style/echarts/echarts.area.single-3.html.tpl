    ...
    <div class="panel panel-default">
    	...
    	<div class="panel-body">
			...
			<div class="input-group">
				...
				<span class="input-group-addon" style="width:auto;">
					<input id="chart-area-opacity-range" type="range" step="0.1" value="0.7"  max="1" min="0">
				</span>
				<input id="chart-area-opacity-text" type="text" class="form-control" disabled="disabled" style="width:45px;" value="0.7" />
			</div><!-- /input-group -->
			<br/>
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
