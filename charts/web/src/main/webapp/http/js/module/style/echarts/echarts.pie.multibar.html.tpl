        ...
        <div class="panel-body">
    		<div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<span class="input-group-addon" style="width:auto;">
		       		<input id="chart-pie-range" type="range" value="28" max="100" min="0">
		       	</span>
		      	<input id="chart-pie-text" type="text" class="form-control" disabled="disabled" style="width:45px;" value="28">
		      	<span class="input-group-addon" style="width:auto;">
		        	%
		      	</span>
		    </div><!-- /input-group -->
    	...
    	<div class="panel-body">
    		<div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<span class="input-group-addon" style="width:auto;">
		       		<input id="chart-pie-r-inner-range" type="range" value="32" max="100" min="0">
		       	</span>
		      	<input id="chart-pie-r-inner-text" type="text" class="form-control" disabled="disabled" style="width:45px;" value="32">
		      	<span class="input-group-addon" style="width:auto;">
		        	%
		      	</span>
		    </div><!-- /input-group -->
    	...
    	<div class="panel-body">
    		<div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<span class="input-group-addon" style="width:auto;">
		       		<input id="chart-pie-r-outter-range" type="range" value="27" max="100" min="0">
		       	</span>
		      	<input id="chart-pie-r-outter-text" type="text" class="form-control" disabled="disabled" style="width:45px;" value="27">
		      	<span class="input-group-addon" style="width:auto;">
		        	%
		      	</span>
		    </div><!-- /input-group -->
