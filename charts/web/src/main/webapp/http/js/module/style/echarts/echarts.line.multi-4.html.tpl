    	...
    	<div class="panel-body">
    		<div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<input id="chart1-line-color-select" type="color" class="form-control" style="width:45px;" value="#7875a4" />
		    </div><!-- /input-group -->
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		        	折线1线宽
		    ...
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<input id="chart2-line-color-select" type="color" class="form-control" style="width:45px;" value="#1587af" />
		    </div><!-- /input-group -->
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		        	折线2线宽
    	...
    	<div class="panel-body">
		    ...
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<span class="input-group-addon" style="width:auto;">
		        	<input id="chart1-font-position-radio-2" name="chart1-font-position-radio" type="radio"  value="bottom" checked="checked"/>
