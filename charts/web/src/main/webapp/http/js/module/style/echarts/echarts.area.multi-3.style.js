...
define(function(require, exports, module) {
	...
	var templateHtml = require("/http/js/module/style/echarts/echarts.area.multi-3.html.tpl");
    ...
    var EChartAreaMultiStyle = (function(){
		...
		var initControlStyle = function(){
            ...
            if(!xAxisStyleSplitLine){
                $("#chart-show-x-splitline-check").attr("checked",false);
            }
