...
define(function(require, exports, module) {
    ...
    var templateHtml = require("/http/js/module/style/highcharts/highcharts.pie.monochrome.html.tpl");
    /**
     *
     */
    var HighChartPieMonochromeStyle = (function(){
        var _isInit = false;
        var _style = {};
        var _container = {};
...
*/
                    ...
                    $("#chart-show-label-check").change(function(){
                        ...
                        //控制是否可以修改
                        $("#chart-textColor-select").attr("disabled",!isShow);
                        $("#chart-font-size-range").attr("disabled",!isShow);
                        $("input[name='chart-font-style']").attr("disabled",!isShow);
 ...
 /*                 //选择字体样式
                    ...
                    $("#chart-show-legend-check").change(function(){
                        ...
                        $("input[name='chart-position-style']").attr("disabled",!isShow);//图例位置是否可选
                        $("input[name='legend-font-style']").attr("disabled",!isShow);//图例字体风格是否可选
                        $("#legend-font-size-range").attr("disabled",!isShow);//图例字体大小是否可选
                        objConfig["option"] = _style = $.extend(true,_style,{
                            legend:{
                                enabled:isShow
                            }
                    ...
                    //图例字体大小
                    $("#legend-font-size-range").change(function(){
                        var size = $(this).val();
                        $("#legend-font-size-text").val(size);
                        objConfig["option"] = _style = $.extend(true,_style,{
                            legend:{
                                itemStyle:{
                                    fontSize:size,
...
/*                    //图例字体风格
                    $("input[name='legend-font-style']").click(function(){
                    ...
                    //选择图例位置
                    $("input[name='chart-position-style']").click(function(){
        ...
        var initControlStyle = function(){
            if(_style.backgroundColor) {
                var pieMonochromeStyle = $.extend(true,{},{
                    backgroundColor: null //背景颜色
                },{
                    backgroundColor:_style.backgroundColor || []
                });

                var pieMonochromeStyleBackgroundColor = pieMonochromeStyle.backgroundColor;
                if(pieMonochromeStyleBackgroundColor != null) {
                    $("#chart-backgroundColor-select").attr("value",pieMonochromeStyleBackgroundColor).val(pieMonochromeStyleBackgroundColor);
                    var $pieMonochromeStyleBackgroundColorParent =  $("#chart-backgroundColor-select").parent("div");
                    $pieMonochromeStyleBackgroundColorParent.html($pieMonochromeStyleBackgroundColorParent.html());
                    //保证控件刷新
                }
            }
...
/*                //饼系列颜色
    ...
    return HighChartPieMonochromeStyle;
});