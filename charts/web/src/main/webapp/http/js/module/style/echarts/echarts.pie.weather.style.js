 ...
 * echart单一饼图样式调整
 *
 * Created by HWLUO on 2016/4/13.
 */
define(function(require, exports, module) {

	var templateHtml = require("/http/js/module/style/echarts/echarts.pie.weather.html.tpl");
	var inputHtml = "<input type=\"color\" class=\"form-control\" style=\"width:45px;\" value=\"#ffffff\" />";

	/**
	 *
	 */
	var EChartPieWeatherStyle = (function(){
		var _isInit = false;
		var _style = {};
		var _container = {};
