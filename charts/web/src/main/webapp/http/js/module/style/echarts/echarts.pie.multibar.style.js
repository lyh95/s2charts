...
define(function(require, exports, module) {
	...
	var templateHtml = require("/http/js/module/style/echarts/echarts.pie.multibar.html.tpl");
    var inputHtml = "<input type=\"color\" class=\"form-control\" style=\"width:45px;\" value=\"#ffffff\" />";
	
    /**
     *
     */
    var EChartBarMultiBarLineStyle = (function(){
        var _isInit = false;
    	var _style = {};
    	var _container = {};
			...
			if(hanlder){
				...
				if(chartObj && objConfig){
                    ...
                    $("#chart-pie-r-inner-range").change(function(){
                        ...
                        var series1 = chartObj.option.series;
                        series1[series1.length - 1].center =  [r2+'%', r1+'%'];
                    ...
                    $("#chart-show-label-check").change(function(){
                        ...
                        for(i=0;i<chartObj.currentColors.length;i++){
                            series1.push({
                                "itemStyle": {
                                    "normal": {
                                        "label": {
		...
		var initControlStyle = function(){
			...
			if(series){
                ...
                var seriesStyle= $.extend(true,{},{series:series1},{
                    series:series
                });
    ...
    return EChartBarMultiBarLineStyle;
});