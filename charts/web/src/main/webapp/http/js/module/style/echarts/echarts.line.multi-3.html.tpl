    	...
    	<div class="panel-body">
    		<div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<input id="chart1-line-color-select" type="color" class="form-control" style="width:45px;" value="#2a3b52" />
		    </div><!-- /input-group -->
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		        	折线1线宽
		    ...
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		      	...
		      	<input id="chart2-line-color-select" type="color" class="form-control" style="width:45px;" value="#ae554a" />
		    </div><!-- /input-group -->
		    <div class="input-group">
		    	<span class="input-group-addon" style="width:auto;">
		        	折线2线宽
