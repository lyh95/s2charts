        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
		    	...
		    	<span class="input-group-addon" style="width:auto;">
                    ...
                    <span class="input-group-addon" style="width:auto;">
		       		<input id="chart-chart-height-range" type="range" value="20" min="5" max="200">
		       	</span>
                    <input id="chart-chart-heigth-text" type="text" class="form-control"  disabled="disabled" value="20" style="width:60px;" >
                    <span class="input-group-addon" style="width:auto;">
		       		px
		       	</span>
                </div><!-- /input-group -->
            ...
            <div class="panel-body">
                ...
                <div class="input-group" style="width:auto;">
		      	<span class="input-group-addon" style="width:auto;">
                    ...
                    <span class="input-group-addon" style="width:auto;">
		        	<input id="chart-font-position-radio-5" name="chart-font-position-radio" type="radio"  value="inside"  checked="checked"/>
