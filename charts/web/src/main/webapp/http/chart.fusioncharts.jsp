...
<%@ page import="com.s2charts.tool.service.FusionchartsService" %>
<%
...
<head>
	...
	<script type="text/javascript" src="/base/http/lib/Fusioncharts/fusioncharts-3.5.1/fusioncharts.js"></script>
	<script type="text/javascript" src="/base/http/lib/Fusioncharts/fusioncharts-3.5.1/themes/fusioncharts.theme.fint.js"></script>
...
<%
}else if(!FusionchartsService.isRightFusionchartsType(chartTypeChart)){
%>
<div class="container" style="padding-top: 60px;width:1000px;">
		...
		<div class="col-xs-12 col-md-6">
					...
					<div class="pull-left">
						<div class="form_up">
							<form id="form" name="form" target="upload-frame" method="post" enctype="multipart/form-data" action="upload">
								...
								<input type="hidden" name="action" value="fusioncharts" >
							</form>
			...
			<div class="tab-content">
				<div class="tab-pane active" id="data-pane">
					...
					<form  name="save-form"  action="javascript:;">
						<div class="pull-left">
							<h4 style="font-family:微软雅黑;">
