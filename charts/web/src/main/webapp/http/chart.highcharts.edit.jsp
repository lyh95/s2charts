...
<head>
	...
	<script type="text/javascript" src="/base/http/lib/Echarts/echarts-2.2.7/echarts-all.js"></script>
	<script type="text/javascript" src="/base/http/js/common/SGIS.Base.js"></script>
	<script type="text/javascript" src="/base/http/lib/Highcharts/Highcharts-4.2.3/highcharts.js"></script>
	<script type="text/javascript" src="/base/http/lib/Highcharts/Highcharts-4.2.3/highcharts-3d.js"></script>
...
//				[ '.tpl', '.tpl?t=' + new Date().getTime() ],
	...
	seajs.use('/http/js/chart.highcharts.edit',function(obj){
