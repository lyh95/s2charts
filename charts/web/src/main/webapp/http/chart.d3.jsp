...
<%@ page import="com.s2charts.tool.service.D3Service" %>
<%
...
<head>
	...
	<!--[if IE]>
	<script type="text/javascript" src="/base/http/lib/canvg-master/flashcanvas.js"></script>
	<![endif]-->	
	<script type="text/javascript" src="/base/http/lib/canvg-master/StackBlur.js" ></script>
	<script type="text/javascript" src="/base/http/lib/canvg-master/rgbcolor.js"></script>
	<script type="text/javascript" src="/base/http/lib/canvg-master/canvg.js"></script>
	
	<script type="text/javascript" src="/base/http/lib/d3/d3.v3.min.js"></script>
...
<% 
		...
		if(!D3Service.isRightD3Type(chartTypeChart)){
%>
		 	<div class="container" style="padding-top: 60px;width:1000px;">
				  		...
				  		<div class="pull-left">
				  			<div class="form_up">
								<form id="form" name="form" target="upload-frame" method="post" enctype="multipart/form-data" action="upload">
									...
									<input type="hidden" name="action" value="d3" > 
								</form>
			  ...
			  <div class="col-xs-12 <%=chartTypeChart.equalsIgnoreCase("d3.bar.drill") ? "col-md-12" : "col-md-6" %>">
				<form id="save-form" name="save-form" action="javascript:;">
			  		...
			  		<div class="pull-left" style="width:90%;">
			  			<h4 style="font-family:微软雅黑;">
			  				<input id="chart-name"  name="chart-name" class="read-only" type="text" readonly="readonly" placeholder="图集标题，点击编辑..." value="图集标题，点击编辑..." />
			  			</h4>
			  		</div>
			  		<div class="hide">
