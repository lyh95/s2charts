 ...
 */
@WebServlet(name = "fusionchartsEditServlet",urlPatterns = "/http/editfusioncharts")
public class FusionchartsEditServlet extends AbstractSuperMapServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/http/chart.fusioncharts.edit.jsp").include(request, response);
    }
