 ...
 */
@WebServlet(name = "antvAddServlet",urlPatterns = "/http/addantv") //标记为servlet，以便启动扫描
public class AntvAddServlet extends AbstractSuperMapServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/http/chart.antv.jsp").include(request, response);
    }
