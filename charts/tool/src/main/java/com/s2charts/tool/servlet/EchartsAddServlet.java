 ...
 */
@WebServlet(name = "echartsAddServlet",urlPatterns = "/http/addecharts")
public class EchartsAddServlet extends AbstractSuperMapServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/http/chart.echarts.jsp").include(request, response);
    }
